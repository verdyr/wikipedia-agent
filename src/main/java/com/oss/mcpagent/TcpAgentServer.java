...
public class TcpAgentServer {
    ...
    public TcpAgentServer(WikipediaService wikipediaService) {
    ...
    private void startTlsServer() throws Exception {
        ...
        try (SSLServerSocket serverSocket = (SSLServerSocket) ssf.createServerSocket(port)) {
            logger.info("Wikipedia MCP TLS Agent started on port " + port);
    ...
    private void handleClient(Socket clientSocket) {
        ...
        try (
            ...
            while ((inputLine = reader.readLine()) != null) {
                ...
                String result = wikipediaService.searchSummary(inputLine);
                writer.write(result + "\n");
                writer.flush();
